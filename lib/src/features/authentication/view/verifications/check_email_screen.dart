    ...
    return Scaffold(
        body: SafeArea(
            child: GestureDetector(
              onTap: () => CommonMethods.sendToNextScreen(context, RoutesPath.verifiedScreen),
              child: Padding(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    children: [
                        ...
                        HeadingAndSubheading(
                            ...
                            subHeading: "We sent you an email to verify your account. Check your inbox, your confirmation email is waiting",
                          letterSpacing: 0.5,
