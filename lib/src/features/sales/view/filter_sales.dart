...
class SalesFilter extends StatelessWidget {
  ...
  const SalesFilter({super.key, required this.onSubmit});
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SmivoxInappTextFields(label: 'Status', controller: categoryController, hintText: hintText),
                    SmivoxInappTextFields(label: 'Staff', controller: labelStatusController, hintText: hintText),
                    SmivoxInappTextFields(label: 'Chanel', controller: priceController, hintText: hintText),
                    SmivoxInappTextFields(label: 'Product', controller: categoryController, hintText: hintText),
